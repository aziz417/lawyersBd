...
<div class="info">
    @include('modal')
    <h2 class="text-center font-bold mb-4">Register For {{ ucfirst($type) }}</h2>
                        ...
                        <div class="row">
                            ...
                            @if(isset($register))
                                <div class="col-5 spouse_name_remove">
                                    ...
                                    <input value="{{ $thikAche }}" class="form-control form-control-sm spouse_name"
                                           type="text" name="spouse_name" placeholder="Spouse Name">
                                </div>
                            @endif
...
@if(isset($register))
    ...
    <div class="info-heading mb-3">
        <p class="text-center mb-0 custom_font_size"><strong>Address</strong></p>
    </div>
    {{--            ADDRESS             --}}
    <div class="row mt-2">
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
            <div class="info">
                <div class="info-heading mb-3">
                    <div class="text-left">
                        <p class="text-center mb-0 custom_font_size"><span
                                    style="float: left; text-align: left; padding-left: 3px"><small>Same As Present Address </small>
                            <input id="presentCheck"
                                   {{ isset($register) && $register->same_as_present_address == 'true' ? 'checked' : '' }} id="same_as_present"
                                   type="checkbox" value="true" name="same_as_present_address"></span><b> Permanent
                                Address</b></p>
                    </div>
                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 permanent_address_disable">
                                <textarea name="permanent_village"
                                          class="form-control form-control-sm permanent_village"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 permanent_address_disable">
                            <input type="text"
                                   ...
                                   class="form-control form-control-sm permanent_post_office">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-4 col">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 ssc_result_append">
                                ...
                                <select name="ssc_result" onchange="changeResult(this, 'ssc')"
                                        class="custom-select custom-select-sm ssc_result">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number"
                                       ...
                                       class="form-control form-control-sm ssc_registration_no">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number"
                                       ...
                                       class="form-control form-control-sm hsc_registration_no">
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="graduation_examination"
                                        class="custom-select custom-select-sm graduation_examination"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select name="graduation_institute"
                                        class="custom-select custom-select-sm graduation_institute">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 graduation_result_append">
                                <select name="graduation_result" onchange="changeResult(this, 'graduation')"
                                        class="custom-select custom-select-sm graduation_result">
                                    <option value="">Select Result</option>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="graduation_course_duration"
                                        class="custom-select custom-select-sm graduation_course_duration">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="graduation_passing_year"
                                        class="custom-select custom-select-sm graduation_passing_year">
                                    <option value="">Select Passing Year</option>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="masters_examination"
                                        class="custom-select custom-select-sm masters_examination"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="masters_institute"
                                        class="custom-select custom-select-sm masters_institute">
                                    <option value="">Select Institute</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8 masters_result_append">
                                <select name="masters_result" onchange="changeResult(this, 'masters')"
                                        class="custom-select custom-select-sm masters_result">
                                    <option value="">Select Result</option>
                                    <option {{ isset($register) ? 'selected' : 'style=display:none' }}>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="masters_course_duration"
                                        class="custom-select custom-select-sm masters_course_duration">
                                    <option value="">Select Course Duration</option>
                                    <option {{ isset($register) ? 'selected' : 'style=display:none' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="masters_passing_year"
                                        class="custom-select custom-select-sm masters_passing_year">
                                    <option value="">Select Passing Year</option>
                ...
                @forelse($register->experiences as $experience)
                    <div class="professionSection info mt-2 singleExperienceRow">
                        <div style="padding: 6px 8px 12px 0!important; text-align: center" class="info-heading mb-3">
                            <small class="text-center mb-0 custom_font_size"><strong>Professional
                                    Experience @if($loop->index < 1) (Current
                            ...
                            @if($loop->index >= 1)
                                ...
                                @else
                                    ...
                                    <button style="margin-right: 10px!important;" type="button"
                                            class="addNewProfession btn btn-sm btn-success float-right">
                                    Add New
                                </button>
                                @endif
                        </span>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input placeholder="Select Date" value="{{ $experience->start_date }}"
                                                   name="start_date[]"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input placeholder="Select Date" value="{{ $experience->end_date  }}"
                                                   name="end_date[]"
        ...
        @else
            <div class="profession-section appendNewProfession">
                <div class="info mt-2 singleExperienceRow">
                    <div style="padding: 6px 8px 12px 0!important; text-align: center" class="info-heading mb-3">
                        <small class="custom_font_size text-center mb-0"><strong>Professional Experience</strong>
                        </small>
